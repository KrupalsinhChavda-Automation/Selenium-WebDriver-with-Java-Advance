...
//	static String fileName = "Extent_" + d.toString().replace(":", "_").replace(" ", "_") + ".html";
	static String fileName1 = "extent.html";
	static String messageBody;
	public static ExtentReports extent = ExtentManager
			.createInstance(System.getProperty("user.dir") + "\\target\\extent_reports\\" + fileName1);
	...
	public void onTestFailure(ITestResult result) {
		...
		// Extent report setup
		String ScreenPathextent = System.getProperty("user.dir") + "\\target\\extent_reports\\screenshot\\"
				+ TestUtil.screenshotName;
		...
		try {
			...
			testReport.get().fail("<b>" + "<font color=" + "red>" + "Screenshot of failure" + "</font>" + "</b>",
					MediaEntityBuilder.createScreenCaptureFromPath(ScreenPathextent).build());
		} catch (IOException e) {
